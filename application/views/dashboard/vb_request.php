                ...
                <div class="card">
                  <div class="card-body">
					...
					<div class="float-right">
						<p class="float-right"> <a href="<?=base_url('dashboard/vb_request/add')?>" class="btn btn-gradient-info mb-2"><i class="mdi mdi-plus-circle-outline"></i> เพิ่มแบบฟอร์ม</a></p>
					</div>
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
						...
						<tr>
							...
							<td class="text-center"><a href="<?=base_url('dashboard/vb_request/edit/'.$item['topic_id'])?>"><label class="badge badge-secondary mr-sm-2" style="cursor:pointer"><i class="mdi mdi-information-outline"></i> แก้ไข</label></a>	</td>
							<td class="text-center"><a href="<?=base_url('dashboard/vb_request/del/'.$item['topic_id'])?>" onclick="return confirm('คุณต้องการลบใช่หรือไม่');"><label class="badge badge-danger mr-sm-2" style="cursor:pointer"><i class="mdi mdi-delete "></i> </label></a>	</td>
						</tr>
						...
						<tr>
							...
							<td class="text-center"><a href="<?=base_url('dashboard/vb_request/deldoc/'.$item2['doc_id'])?>" onclick="return confirm('คุณต้องการลบใช่หรือไม่');"><label class="badge badge-danger mr-sm-2" style="cursor:pointer"><i class="mdi mdi-delete "></i> </label></a>	</td>
						</tr>
						<?php }?>
						<?php }?>
						<?php }?>
