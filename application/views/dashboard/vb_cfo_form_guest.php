							...
							<form class="forms-sample" method="post">
								<div class="mb-5">
									<div class="form-group row">
										...
										<label for="topic_name" class="col-sm-10 col-form-label"><?=$cfo_project_name?></label>
										
									</div>
									<div class="form-group row">
										<label for="topic_name" class="col-sm-2 col-form-label">ระบุเดือน</label>
										<label for="topic_name" class="col-sm-2 col-form-label"><?=getMonth($cfo_month)?></label>
										
										<label for="topic_name" class="col-sm-1 col-form-label">ระบุปี</label>
										<label for="topic_name" class="col-sm-2 col-form-label"><?=$cfo_year?></label>

									</div>
									
									<?php if(@in_array($member['m_user'], $cfo_cv_permission)){?>
										...
										<table class="table table-striped">
											...
											<tbody>
												<tr>
													...
													<td>
														<select name="cfo_cv[status][CR_1]" class="form-control" disabled>
													...
													<td class="text-center"><?=@$cfo_cv_obj->owner->CR_1?></td>
													<td class="text-center"><?=@$cfo_cv_obj->date_start->CR_1?></td>
													<td class="text-center"><?=@$cfo_cv_obj->date_end->CR_1?></td>
												...
												<tr>
													...
													<td>
														<select name="cfo_cv[status][CR_2]" class="form-control" disabled>
													...
													<td class="text-center"><?=@$cfo_cv_obj->owner->CR_2?></td>
													<td class="text-center"><?=@$cfo_cv_obj->date_start->CR_2?></td>
													<td class="text-center"><?=@$cfo_cv_obj->date_end->CR_2?></td>
												...
												<tr>
													...
													<td>
														<select name="cfo_cv[status][CR_3]" class="form-control" disabled>
													...
													<td class="text-center"><?=@$cfo_cv_obj->owner->CR_3?></td>
													<td class="text-center"><?=@$cfo_cv_obj->date_start->CR_3?></td>
													<td class="text-center"><?=@$cfo_cv_obj->date_end->CR_3?></td>
												...
												<tr>
													...
													<td>
														<select name="cfo_cv[status][CR_4]" class="form-control" disabled>
															<option value="">ระบุสถานะ</option>
													...
													<td class="text-center"><?=@$cfo_cv_obj->owner->CR_4?></td>
													<td class="text-center"><?=@$cfo_cv_obj->date_start->CR_4?></td>
													<td class="text-center"><?=@$cfo_cv_obj->date_end->CR_4?></td>
												...
												<tr>
													...
													<td>
														<select name="cfo_cv[status][CR_5]" class="form-control" disabled>
															<option value="">ระบุสถานะ</option>
													...
													<td class="text-center"><?=@$cfo_cv_obj->owner->CR_5?></td>
													<td class="text-center"><?=@$cfo_cv_obj->date_start->CR_5?></td>
													<td class="text-center"><?=@$cfo_cv_obj->date_end->CR_5?></td>
												...
												<tr>
													...
													<td>
														<select name="cfo_cv[status][CR_6]" class="form-control" disabled>
															<option value="">ระบุสถานะ</option>
													...
													<td class="text-center"><?=@$cfo_cv_obj->owner->CR_6?></td>
													<td class="text-center"><?=@$cfo_cv_obj->date_start->CR_6?></td>
													<td class="text-center"><?=@$cfo_cv_obj->date_end->CR_6?></td>
												...
												<tr>
													...
													<td>
														<select name="cfo_cv[status][CR_7]" class="form-control" disabled>
															<option value="">ระบุสถานะ</option>
													...
													<td class="text-center"><?=@$cfo_cv_obj->owner->CR_7?></td>
													<td class="text-center"><?=@$cfo_cv_obj->date_start->CR_7?></td>
													<td class="text-center"><?=@$cfo_cv_obj->date_end->CR_7?></td>
												...
												<tr>
													...
													<td>
														<select name="cfo_cv[status][CR_8]" class="form-control" disabled>
															<option value="">ระบุสถานะ</option>
													...
													<td class="text-center"><?=@$cfo_cv_obj->owner->CR_8?></td>
													<td class="text-center"><?=@$cfo_cv_obj->date_start->CR_8?></td>
													<td class="text-center"><?=@$cfo_cv_obj->date_end->CR_8?></td>
									...
									<?php if(@in_array($member['m_user'], $cfo_vd_permission)){?>
									<?php if(@$cfo_cv_obj->status->CR_3=="accept"){?>
									<div class="form-group row" style="background-color: #d0a4e6;margin: 0;">
								...
								<div class="form-group row">
									<div class="col-sm-12 text-center">
										...
										<?php if( @in_array($member['m_user'], $cfo_vd_permission) || @in_array($member['m_user'], $cfo_cv_permission)){?>
										<button type="submit" class="btn btn-gradient-primary mr-2">บันทึก</button>
										<?php }else{?>
										<a href="<?=base_url('dashboard/cfo')?>" class="btn btn-gradient-primary mr-2">กลับหน้าหลัก</a>
										<?php }?>
									</div>
								</div>
							</form>
