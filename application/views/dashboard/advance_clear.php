			...
			<?php 
				...
				if($rsClear!=null){
					...
					$advance_clear_datetime = $rsClear[0]->advance_clear_datetime==""? $advance_clear_datetime : ConvertToThaiDate($rsClear[0]->advance_clear_datetime,0);
												...
												<tr>
													...
													<th>
														<div class="form-check form-check-flat form-check-primary">
															...
															<input type="checkbox" name="advance_verify_is" value="1" class="form-check-input" disabled <?=$advance_verify_is==1?'checked':''?>> เอกสารถูกต้อง<i class="input-helper"></i></label>
														</div>
													</th>
												</tr>
												...
												<tr>
													...
													<th>
														<div class="form-check form-check-flat form-check-primary">
															...
															<input type="checkbox" name="advance_is_pay" value="1" class="form-check-input" disabled <?=$advance_is_pay==1?'checked':''?>> อนุมัติ<i class="input-helper"></i></label>
														</div>
													</th>
												</tr>
						...
						<div class="card-body">
							...
							<form class="forms-sample" method="post">
								<div class="form-group row">
									...
									<div class="col-sm-7">
										<input type="text" class="form-control" value="<?=$advance_clear_datetime?>" readonly>
									</div>
								</div>
								<div class="form-group row">
									<label for="advance_central" class="col-sm-5 col-form-label">ยอดทดรองจ่าย</label>
									<div class="col-sm-7">
										<input type="text" class="form-control" id="clear_price_total" value="<?=$price_total?>" readonly>
									</div>
								</div>
								<div class="form-group row">
									<label for="advance_central" class="col-sm-5 col-form-label">ยอดจ่ายจริง</label>
									<div class="col-sm-7">
										<input type="text" class="form-control my-input" id="advance_clear_real_money" name="advance_clear_real_money" value="<?=$advance_clear_real_money?>" <?=$advance_clear_verify_is==1?'readonly':''?>>
									</div>
								</div>
								<div class="form-group row">
									<label for="advance_central" class="col-sm-5 col-form-label">เท่ากับ</label>
									<div class="col-sm-7">
										<input type="text" class="form-control" id="price_result" readonly value="<?=($price_total-$advance_clear_real_money)?>">
									</div>
								</div>
								<div id="box_plus" <?=$advance_clear_status==1?'':'style="display:none;"'?> <?=$advance_clear_price_total==0?'style="display:none;"':''?>>
									<div class="form-group row">
										...
										<div class="col-sm-7">
											<input type="text" class="form-control" id="result_balance" readonly value="<?=$advance_clear_price_total?>">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-7">
											<select class="form-control" name="advance_clear_type" id="advance_clear_type" required <?=$member['m_level']==3||$member['m_level']==1?'readonly':''?>>
												<option value="1" <?=$advance_clear_type==1?'selected':''?>>เงินสด</option>
												<option value="2" <?=$advance_clear_type==2?'selected':''?>>โอนเงิน</option>
												<option value="3" <?=$advance_clear_type==3?'selected':''?>>สำรองจ่าย</option>
											</select>
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-7">
											<input type="text" class="form-control" name="advance_clear_type_note" placeholder="กรณีเลือก สำรองจ่าย" value="<?=$advance_clear_type_note?>">
										</div>
									</div>
								</div>
								<div id="box_minus" <?=$advance_clear_status==0?'':'style="display:none;"'?> <?=$advance_clear_price_total==0?'style="display:none;"':''?>>
									<div class="form-group row">
										...
										<div class="col-sm-7">
											<input type="text" class="form-control" id="result_add" readonly value="<?=($price_total-$advance_clear_real_money)?>">
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-7">
										<div class="form-check form-check-flat form-check-primary">
											...
											<input type="checkbox" name="advance_clear_verify_is" value="1" class="form-check-input" <?=$member['m_level']==1?'disabled':''?> <?=$advance_clear_verify_is==1?'checked':''?> > อนุมัติ<i class="input-helper"></i></label>
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-7">
										<div class="form-check form-check-flat form-check-primary">
											...
											<input type="checkbox" name="advance_clear_approve_is" value="1" class="form-check-input" <?=$member['m_level']==2||$member['m_level']==1?'disabled':''?> <?=$advance_clear_approve_is==1?'checked':''?> > อนุมัติ<i class="input-helper"></i></label>
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									<div class="col-sm-12 text-center">
										<input type="hidden" name="advance_clear_status" id="advance_clear_status" value="<?=$advance_clear_status?>">
										...
										<input type="hidden" name="advance_clear_price_total" id="advance_clear_price_total" value="<?=$advance_clear_price_total?>">
