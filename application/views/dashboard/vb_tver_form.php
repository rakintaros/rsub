							...
							<form class="forms-sample" method="post">
								<div class="mb-5">
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" name="tver_project_name"
												value="<?=$tver_project_name?>">
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-2">
											<select class="form-control mb-2 mr-sm-2" id="tver_month" name="tver_month">
												<?php for($i=1;$i<=12;$i++){?>
												<option value="<?=$i?>" <?=$tver_month==$i?'selected':''?>><?=getMonth($i)?>
												</option>
												<?php }?>
											</select>
										</div>
										...
										<div class="col-sm-1">
											<select class="form-control mb-2 mr-sm-2" id="tver_year" name="tver_year">
												...
												<option value="<?=($y+543)?>" <?=$tver_year==($y+543)?'selected':''?>>
													<?=($y+543)?></option>
												<?php }?>
											</select>
										</div>
											...
											<div class="form-check form-check-inline" style="display: inline-flex !important;">
												<label class="form-check-label">
													<input type="checkbox" class="form-check-input" name="tver_cv_permission[]"
														value="<?=$item->member_username?>" <?=@in_array($item->member_username, $tver_cv_permission) ? 'checked':''?>> <?=$item->member_name?></label>
											</div>
											<?php }?>
										</div>
									</div>
										...
										<table class="table table-striped">
											...
											<tbody>
												<tr>
													...
													<td>
														<select name="tver_cv[status][CR_1]" class="form-control">
													...
													<td>
														<select name="tver_cv[owner][CR_1]" class="form-control">
															<option value="">ผู้ประเมิน</option>
															<?php foreach($user_permissions as $item){?>
															<?php if(in_array($item->member_username, $tver_cv_permission)){?>
																<option value="<?=$item->member_username?>" <?=$tver_cv_obj->owner->CR_1==$item->member_username ? 'selected':''?>><?=$item->member_name?></option>
															<?php }?>
															<?php }?>
														</select>
														
													</td>
													<td><input type="text" class="form-control" name="tver_cv[date_start][CR_1]" value="<?=@$tver_cv_obj->date_start->CR_1?>" data-provide="datepicker" data-date-language="th-th"></td>
													<td><input type="text" class="form-control" name="tver_cv[date_end][CR_1]" value="<?=@$tver_cv_obj->date_end->CR_1?>" data-provide="datepicker" data-date-language="th-th"></td>
													...
													<td class="text-center"><button type="button" class="btn btn-gradient-info btn-sm btn_vb_setfile" vb_type="tver" vb_id="<?=$tver_id?>" vb_point="CR_1"><i
												...
												<tr>
													...
													<td>
														<select name="tver_cv[status][CR_2]" class="form-control">
													...
													<td>
														<select name="tver_cv[owner][CR_2]" class="form-control">
															<option value="">ผู้ประเมิน</option>
															<?php foreach($user_permissions as $item){?>
															<?php if(in_array($item->member_username, $tver_cv_permission)){?>
																<option value="<?=$item->member_username?>" <?=$tver_cv_obj->owner->CR_2==$item->member_username ? 'selected':''?>><?=$item->member_name?></option>
															<?php }?>
															<?php }?>
														</select>
													</td>
													<td><input type="text" class="form-control" name="tver_cv[date_start][CR_2]" value="<?=@$tver_cv_obj->date_start->CR_2?>" data-provide="datepicker" data-date-language="th-th"></td>
													<td><input type="text" class="form-control" name="tver_cv[date_end][CR_2]" value="<?=@$tver_cv_obj->date_end->CR_2?>" data-provide="datepicker" data-date-language="th-th"></td>
													...
													<td class="text-center"><button type="button" class="btn btn-gradient-info btn-sm btn_vb_setfile" vb_type="tver" vb_id="<?=$tver_id?>" vb_point="CR_2"><i
																class="mdi mdi-settings"></i></button></td>
												</tr>
												<tr>
													...
													<td>
														<select name="tver_cv[status][CR_3]" class="form-control">
													...
													<td>
														<select name="tver_cv[owner][CR_3]" class="form-control">
															<option value="">ผู้ประเมิน</option>
															<?php foreach($user_permissions as $item){?>
															<?php if(in_array($item->member_username, $tver_cv_permission)){?>
																<option value="<?=$item->member_username?>" <?=$tver_cv_obj->owner->CR_3==$item->member_username ? 'selected':''?>><?=$item->member_name?></option>
															<?php }?>
															<?php }?>
														</select>
													</td>
													<td><input type="text" class="form-control" name="tver_cv[date_start][CR_3]" value="<?=@$tver_cv_obj->date_start->CR_3?>" data-provide="datepicker" data-date-language="th-th"></td>
													<td><input type="text" class="form-control" name="tver_cv[date_end][CR_3]" value="<?=@$tver_cv_obj->date_end->CR_3?>" data-provide="datepicker" data-date-language="th-th"></td>
													...
													<td class="text-center"><button type="button" class="btn btn-gradient-info btn-sm btn_vb_setfile" vb_type="tver" vb_id="<?=$tver_id?>" vb_point="CR_3"><i
																class="mdi mdi-settings"></i></button></td>
												</tr>
												...
												<tr>
													...
													<td>
														<select name="tver_cv[status][CR_4]" class="form-control">
															<option value="">ระบุสถานะ</option>
													...
													<td>
														<select name="tver_cv[owner][CR_4]" class="form-control">
															<option value="">ผู้ประเมิน</option>
															<?php foreach($user_permissions as $item){?>
															<?php if(in_array($item->member_username, $tver_cv_permission)){?>
																<option value="<?=$item->member_username?>" <?=$tver_cv_obj->owner->CR_4==$item->member_username ? 'selected':''?>><?=$item->member_name?></option>
															<?php }?>
															<?php }?>
														</select>
													</td>
													<td><input type="text" class="form-control" name="tver_cv[date_start][CR_4]" value="<?=@$tver_cv_obj->date_start->CR_4?>" data-provide="datepicker" data-date-language="th-th"></td>
													<td><input type="text" class="form-control" name="tver_cv[date_end][CR_4]" value="<?=@$tver_cv_obj->date_end->CR_4?>" data-provide="datepicker" data-date-language="th-th"></td>
													...
													<td class="text-center"><button type="button" class="btn btn-gradient-info btn-sm btn_vb_setfile" vb_type="tver" vb_id="<?=$tver_id?>" vb_point="CR_4"><i
																class="mdi mdi-settings"></i></button></td>
												</tr>
												<tr>
													...
													<td>
														<select name="tver_cv[status][CR_5]" class="form-control">
															<option value="">ระบุสถานะ</option>
													...
													<td>
														<select name="tver_cv[owner][CR_5]" class="form-control">
															<option value="">ผู้ประเมิน</option>
															<?php foreach($user_permissions as $item){?>
															<?php if(in_array($item->member_username, $tver_cv_permission)){?>
																<option value="<?=$item->member_username?>" <?=$tver_cv_obj->owner->CR_5==$item->member_username ? 'selected':''?>><?=$item->member_name?></option>
															<?php }?>
															<?php }?>
														</select>
													</td>
													<td><input type="text" class="form-control" name="tver_cv[date_start][CR_5]" value="<?=@$tver_cv_obj->date_start->CR_5?>" data-provide="datepicker" data-date-language="th-th"></td>
													<td><input type="text" class="form-control" name="tver_cv[date_end][CR_5]" value="<?=@$tver_cv_obj->date_end->CR_5?>" data-provide="datepicker" data-date-language="th-th"></td>
													...
													<td class="text-center"><button type="button" class="btn btn-gradient-info btn-sm btn_vb_setfile" vb_type="tver" vb_id="<?=$tver_id?>" vb_point="CR_5"><i
																class="mdi mdi-settings"></i></button></td>
												</tr>
												<tr>
													...
													<td>
														<select name="tver_cv[status][CR_6]" class="form-control">
															<option value="">ระบุสถานะ</option>
													...
													<td>
														<select name="tver_cv[owner][CR_6]" class="form-control">
															<option value="">ผู้ประเมิน</option>
															<?php foreach($user_permissions as $item){?>
															<?php if(in_array($item->member_username, $tver_cv_permission)){?>
																<option value="<?=$item->member_username?>" <?=$tver_cv_obj->owner->CR_6==$item->member_username ? 'selected':''?>><?=$item->member_name?></option>
															<?php }?>
															<?php }?>
														</select>
													</td>
													<td><input type="text" class="form-control" name="tver_cv[date_start][CR_6]" value="<?=@$tver_cv_obj->date_start->CR_6?>" data-provide="datepicker" data-date-language="th-th"></td>
													<td><input type="text" class="form-control" name="tver_cv[date_end][CR_6]" value="<?=@$tver_cv_obj->date_end->CR_6?>" data-provide="datepicker" data-date-language="th-th"></td>
													...
													<td class="text-center"><button type="button" class="btn btn-gradient-info btn-sm btn_vb_setfile" vb_type="tver" vb_id="<?=$tver_id?>" vb_point="CR_6"><i
																class="mdi mdi-settings"></i></button></td>
												</tr>
												<tr>
													...
													<td>
														<select name="tver_cv[status][CR_7]" class="form-control">
															<option value="">ระบุสถานะ</option>
													...
													<td>
														<select name="tver_cv[owner][CR_7]" class="form-control">
															<option value="">ผู้ประเมิน</option>
															<?php foreach($user_permissions as $item){?>
															<?php if(in_array($item->member_username, $tver_cv_permission)){?>
																<option value="<?=$item->member_username?>" <?=$tver_cv_obj->owner->CR_7==$item->member_username ? 'selected':''?>><?=$item->member_name?></option>
															<?php }?>
															<?php }?>
														</select>
													</td>
													<td><input type="text" class="form-control" name="tver_cv[date_start][CR_7]" value="<?=@$tver_cv_obj->date_start->CR_7?>" data-provide="datepicker" data-date-language="th-th"></td>
													<td><input type="text" class="form-control" name="tver_cv[date_end][CR_7]" value="<?=@$tver_cv_obj->date_end->CR_7?>" data-provide="datepicker" data-date-language="th-th"></td>
													...
													<td class="text-center"><button type="button" class="btn btn-gradient-info btn-sm btn_vb_setfile" vb_type="tver" vb_id="<?=$tver_id?>" vb_point="CR_7"><i
																class="mdi mdi-settings"></i></button></td>
												</tr>
												<tr>
													...
													<td>
														<select name="tver_cv[status][CR_8]" class="form-control">
															<option value="">ระบุสถานะ</option>
													...
													<td>
														<select name="tver_cv[owner][CR_8]" class="form-control">
															<option value="">ผู้ประเมิน</option>
															<?php foreach($user_permissions as $item){?>
															<?php if(in_array($item->member_username, $tver_cv_permission)){?>
																<option value="<?=$item->member_username?>" <?=$tver_cv_obj->owner->CR_8==$item->member_username ? 'selected':''?>><?=$item->member_name?></option>
															<?php }?>
															<?php }?>
														</select>
													</td>
													<td><input type="text" class="form-control" name="tver_cv[date_start][CR_8]" value="<?=@$tver_cv_obj->date_start->CR_8?>" data-provide="datepicker" data-date-language="th-th"></td>
													<td><input type="text" class="form-control" name="tver_cv[date_end][CR_8]" value="<?=@$tver_cv_obj->date_end->CR_8?>" data-provide="datepicker" data-date-language="th-th"></td>
													...
													<td class="text-center"><button type="button" class="btn btn-gradient-info btn-sm btn_vb_setfile" vb_type="tver" vb_id="<?=$tver_id?>" vb_point="CR_8"><i
																class="mdi mdi-settings"></i></button></td>
												</tr>
												<?php }?>
											</tbody>
									...
									<div class="form-group row" style="background-color: #d0a4e6;margin: 0;">
										...
										<div class="col-sm-10">
											...
											<div class="form-check form-check-inline" style="display: inline-flex !important;">
												<label class="form-check-label">
													<input type="checkbox" class="form-check-input" name="tver_vd_permission[]"
														value="<?=$item->member_username?>" <?=@in_array($item->member_username, $tver_vd_permission) ? 'checked':''?>> <?=$item->member_name?></label>
											</div>
											<?php }?>
										</div>
									</div>
										...
										<table class="table table-striped">
											...
											<tbody>
												<tr>
													...
													<td class="text-center"><button type="button" class="btn btn-gradient-info btn-sm btn_vb_setfile" vb_type="tver" vb_id="<?=$tver_id?>" vb_point="VD_1"><i
																class="mdi mdi-settings"></i></button></td>
												</tr>
												<tr>
													<td class="text-center">2</td>
													...
													<td class="text-center"><button type="button" class="btn btn-gradient-info btn-sm btn_vb_setfile" vb_type="tver" vb_id="<?=$tver_id?>" vb_point="VD_2"><i
																class="mdi mdi-settings"></i></button></td>
												</tr>
												<tr>
													<td class="text-center">3</td>
													...
													<td class="text-center"><button type="button" class="btn btn-gradient-info btn-sm btn_vb_setfile" vb_type="tver" vb_id="<?=$tver_id?>" vb_point="VD_3"><i
																class="mdi mdi-settings"></i></button></td>
												</tr>
												<tr>
													<td class="text-center">4</td>
													...
													<td class="text-center"><button type="button" class="btn btn-gradient-info btn-sm btn_vb_setfile" vb_type="tver" vb_id="<?=$tver_id?>" vb_point="VD_4"><i
																class="mdi mdi-settings"></i></button></td>
												</tr>
												<tr>
													<td class="text-center">5</td>
													...
													<td class="text-center"><button type="button" class="btn btn-gradient-info btn-sm btn_vb_setfile" vb_type="tver" vb_id="<?=$tver_id?>" vb_point="VD_5"><i
																class="mdi mdi-settings"></i></button></td>
												</tr>
											</tbody>
										</table>
