			    ...
			    <div class="card">
			      <div class="card-body">
			        <div class="float-right">
			          <p class="float-right"> <a href="<?=base_url('dashboard/vb_cfo/add')?>"
			        ...
			        <div class="table-responsive">
                      ...
                      <tr>
                        ...
                        <td class="text-center"><a title="ลบ" href="<?=base_url('dashboard/vb_cfo/del/'.$item->cfo_id)?>" onclick="return confirm('คุณต้องการลบใช่หรือไม่');"><label class="badge badge-danger mr-sm-2" style="cursor:pointer"><i class="mdi mdi-delete "></i> </label></a></td>
                      </tr>
			              <?php }?>
			            </tbody>
			          </table>
